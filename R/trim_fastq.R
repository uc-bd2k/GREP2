...
trim_fastq <- function(srr_id,fastq_dir,instrument,trimmomatic_path,
    ...
    if (library_layout=="SINGLE") {
        ...
        system(paste0("java -jar /home/naim/Trimmomatic-0.36/
        trimmomatic-0.36.jar SE -phred33 -threads ",n_thread," ",
        fq, " ", fq_se, " ",	"ILLUMINACLIP:",
        trimmomatic_path, "/adapters/", adapters(instrument),
        "-SE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 
        MINLEN:36"))
    } else {
        ...
        system(paste0("java -jar /home/naim/Trimmomatic-0.36/
        trimmomatic-0.36.jar PE -phred33 -threads ",n_thread," ",
