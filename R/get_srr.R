...
#'
#' \code{get_srr} downloads SRA files using Aspera (\url{http://www.asperasoft.com/}) or FTP. 
...
#' @param prefetch_workspace directory where SRA run files will be downloaded. This parameter is needed if \code{ascp=TRUE}. 
